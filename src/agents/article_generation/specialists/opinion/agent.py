...
class OpinionAgent(BaseSpecialistAgent):
    """Evaluates fair interpretation vs misleading extrapolation."""
    ...
    def evaluate(
        ...
        *,
        ...
        logger.info("Opinion prompt assembled: %d chars", len(user_prompt))
