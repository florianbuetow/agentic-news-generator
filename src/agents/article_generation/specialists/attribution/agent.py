...
class AttributionAgent(BaseSpecialistAgent):
    """Checks attribution quality and source traceability."""
    ...
    def evaluate(
        ...
        *,
        ...
        """Evaluate concern using attribution prompt."""
        ...
        logger.info("Attribution prompt assembled: %d chars", len(user_prompt))
        ...
        logger.info("Attribution verdict: concern_id=%d status=%s misleading=%s", verdict.concern_id, verdict.status, verdict.misleading)
        return verdict
