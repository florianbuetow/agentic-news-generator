...
- Topic boundary detection (LLM boundary detector, reference-evaluation harness, indexing-guardrail simulation, and boundary metrics)
- Removed stale topic detection sections from the config template.
