...
This script is structured like a Jupyter notebook with linear execution.
"""
...
def load_model_specifications() -> Dict[str, Dict]:
    ...
    models_file = Path(__file__).parent / "benchmark_models.json"
...
"""
## Section 5: Calculate and Display Metrics
...
"""
### Visualization 5a & 5b: Performance vs Model Characteristics
...
"""
### Visualization 6a & 6b: Speed vs Model Characteristics
